...
Full system design, component map, and key decisions live in `README.md`. Read it before making structural changes. The most critical points for agentic workers:
...
When making architectural changes, update `README.md` to reflect them.
